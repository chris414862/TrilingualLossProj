...
EXPDIR="exps/HYPERSHPERIC_CUSTOM_AVG_HEAD"
...
extra_args=( "--batch-size=128" "--lr=.001" "--lr-ramp=0.1" "--mode=train" "--langs=english,hindi,japanese")
extra_args+=("--image-output-head=avg" "--audio-output-head=avg" ) 
extra_args+=("--n-epochs=75" "--loss=hyperspheric" )
extra_args+=("--hsphere-align-weight=1.0" "--hsphere-uniform-weight=1.0" "--hsphere-alpha=2.0" "--hsphere-t=2.0" "--use-custom-hsphere")
#"--no-pbar") 
