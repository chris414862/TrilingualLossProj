...
EXPDIR="exps/MV_TRNSF_LR0001_DO1_MASK"
...
# extra_args+=("--layer-widths=16,32,64,64,128")
# extra_args+=("--edim=128")
...
extra_args+=("--image-output-head=transformer" "--audio-output-head=transformer")
extra_args+=("--ff-dim=2048")
extra_args+=("--padding-mask")
extra_args+=("--mh_dropout=.1")
