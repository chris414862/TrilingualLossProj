...
# This moves the cursor down 15 rows after the shell exits or error occurs. Helps to save progress display info on ctrl-c
trap 'printf "\x1b[20E"' err exit


#### Set script defualt arguments
# Experiment directory
EXPDIR="$SCRATCH/exps/MV_CODING_AVG_OTHERS_CONTRAST"
