...
extra_args=( "--batch-size=128" "--lr=.001" "--mode=train" "--langs=english,japanese,hindi")
extra_args+=("--image-output-head=avg" "--audio-output-head=avg" "--full-graph") 
extra_args+=("--n-epochs=75" "--loss=hyperspheric" "--hsphere-alpha=2.0" "--hsphere-t=2.0" )
extra_args+=("--hsphere-align-weight=.001" "--hsphere-uniform-weight=.001" "--lr-ramp=0.001" "--use-custom-hsphere")
#"--weight-decay=0.0")
#"--no-pbar") 
